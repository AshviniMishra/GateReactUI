...
const ApplicationForm = React.lazy(() =>
  import("../components/UI/Forms/ApplicationForm/ApplicationForm")
);
...
const ChangeGatePaper = React.lazy(() =>
  import("../components/UI/Forms/ChangeGatePaper/ChangeGatePaper")
);
    ...
    <BrowserRouter basename="/gate2021/">
      <Layout>
        <div>
          ...
          />
          <Route
            path="/changeCandidateDetails"
            exact
            render={() => (
              <Suspense fallback={<Spinner animation="border" />}>
                <ChangeApplicantDetails />
              </Suspense>
            )}
          />
          <Route
            path="/forgotCredential"
            exact
            render={() => (
              <Suspense fallback={<Spinner animation="border" />}>
                <ForgotCredentials />
          ...
          />
          <Route
            path="/forgotEnrolIDRegisterID"
            exact
            render={() => (
              <Suspense fallback={<Spinner animation="border" />}>
                <ForgotEnrolIDRegisterID />
              </Suspense>
            )}
          />
          <Route
        ...
        <Route
          path="/documentrequirement"
          component={() => {
            window.location.href =
              "http://gate.iitd.ac.in/documentrequirement.php";
            return null;
          }}
        />
