...
class ChangeExamCity extends Component {
            ...
            applicationForm: {
                gatePaperDetails: {
                    gatePaper: {
                        ...
                        elementConfig: {
                            options: [
                                { value: 'Aerospace Engineering(AE)', displayValue: 'Aerospace Engineering(AE)' },
                                { value: 'Agricultural Engineering(AG)', displayValue: 'Agricultural Engineering(AG)' },
                                { value: 'Architechture And Planning(AR)', displayValue: 'Architechture And Planning(AR)' },
                                { value: 'Biomedical Engineering(BM)', displayValue: 'Biomedical Engineering(BM)' }
                            ],
                            id: 'gatePaper'
                        },
                ...
                ApplicantPersonalDetails: {
                    ...
                    guradianName: {
                        ...
                        desc: 'Parent/Guardian name can be maximum of length 50 characters and can not contain special characters except dot (.), hyphen (-) and blank space',
                        value: ''
                    },
                ...
                CorrespondenceDetails: {
                    ...
                    stateUt: {
                        ...
                        desc: 'If the country is other than India, the State/Union Territory will appear as "Other".',
                        value: ''
                    },
                ...
                Qualifying_Degree_Details: {
                    CollegePinCode: {
                        ...
                        desc: 'Enter PIN code of college. Please enter 999999 if it is not in India',
                        value: ''
                    },
                    CountryOfCollege: {
                        elementType: 'input',
                    ...
                    rollNo: {
                        ...
                        desc: 'Please ensure that you fill Institute Registration Number / Roll No as per your eligibility certificate and not the GATE 2020 enrollment ID.',
                        value: ''
                    },
                    ...
                    degreeUniv: {
                        ...
                        desc: 'As you start typing the university name, you will see a list of universities. Please select your university if it appears in the list. Otherwise, type the university name completely without any special characters (Note: Length should not exceed 100 characters).apostrophe(' + ') not allowed.',
                        value: ''
                    },
                    ...
                    collegeName: {
                        ...
                        label: 'College Name',
                        desc: 'As you start typing the college name, you will see a list of colleges. Please select your college if it appears in the list. Otherwise, type the college name completely without any special characters (Note: Length should not exceed 100 characters).apostrophe(' + ') not allowed.',
                        value: ''
                    }
                },
                ...
                Upload_Documents: {
                    uploadPhoto: {
                        ...
                        desc: 'Upload a JPEG/JPG/PNG file of your photograph of maximum pixel resolution 480 x 640 and minimum pixel resolution 240 x 320. Aspect ratio (width : height) has to be between 0.6603 and 0.8933, Size of an image should be in a range of 5KB to 200KB. ' + <a href="#">Guidelines for uploading the Photograph</a>,
                        value: ''
                    },
                    ...
                    uploadSign: {
                        ...
                        desc: 'Upload a JPEG/JPG file of your signature of maximum pixel resolution 160 x 560 and minimum pixel resolution 80 x 280. Aspect ratio (height : width) has to be between 3.1586 and 4.0360, Size of an image should be in a range of 5KB to 150KB. Guidelines for uploading the Signature',
                        value: ''
                    },
                    ...
                    eligibilityDoc: {
                        ...
                        desc: 'Please upload any one of the following valid Documents (File size should between 10 KB and 500 KB , pdf format)' +
                ...
                Declaration: {
                    ...
                    dec: {
                        ...
                        elementConfig: {
                            options: [
                                {
                                    value: 'I have verified the details filled in the application form.' +
    ...
    populateData(event, inputIdentifier, key) {
        ...
        axios.post('http://localhost:8080/gate2021/fetchExamCities1', country).then(
            response => {
                //localStorage.setItem('session', JSON.stringify(state));
                console.log('[Reducer.js] Response -> ' + JSON.stringify(response, null, 5));
            }
        ).catch(
            error => {
                console.error('[Reducer.js] Some error occured while loggin in ' + error);
            }
        )

        subSection['examCity1'].elementConfig.options = [{ value: 'UP', displayValue: 'UP' },
        ...
        { value: 'United Arab Emirates', displayValue: 'United Arab Emirates' }].slice();
        updatedApplicationForm[key] = {
            ...subSection
        };
    ...
    inputChangedHandler = (event, inputIdentifier, key) => {
        ...
        if (inputIdentifier === 'firstName' || inputIdentifier === 'middleName' || inputIdentifier === 'lastName') {

            subSection['name'].value = subSection['firstName'].value.toUpperCase() + ' ' + subSection['middleName'].value.toUpperCase() + ' ' + subSection['lastName'].value.toUpperCase();

            if (subSection['name'].value !== '' && subSection['name'].value != null) {
                subSection['name'].valid = true;
            }
            else
                subSection['name'].valid = false;
        }
        updatedApplicationForm[key] = {
            ...subSection
        }
    ...
    render() {
        ...
        let form = (
            <React.Fragment>
                <h1 className="text-center"><Badge variant="light" style={{ width: '100%' }}>Application Form</Badge></h1>
                                        ...
                                        <Card.Body>
                                            {
                                                hE.arr.map(formElement => (
                                                    <Input
                                                        ...
                                                        selected={formElement.config.elementConfig.select == true ? (event) => this.populateData(event, formElement.id, hE.id) : null}
...
export default connect(mapStateToProps, mapDispatchToProps)(ChangeExamCity);