                        ...
                        <Col xs={12} md={12} large={12}>
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>e-Challan Payment made. Your payment has not yet been received by GATE</td>
                                </tr>
                            </table>
                        </Col>
                        <Col>
                ...
                <Row>
                    ...
                    <Col xs={12} md={12}>
                        <div class="text-right">
                            <Row>
                                <Col xs={6} md={6} large={6}>{/* <jsp:include page="/WEB-INF/jsp/OTP.jsp"/> */}
                                    {this.props.context.appStage === 'CHANGE_EXAM_CITY' ? <a class="btn btn-primary" href="changeExamCity.html">Change
                                    Personal Data</a>
                                        :
                                        <a class="btn btn-primary" href="changeExamCity.html">Change
                                    Exam City</a>
                                    }</Col>
                        ...
                        <Col xs={12} md={12}>
                            <Row>
                                ...
                                <Col xs={6} md={6} large={6}>
                                    {this.props.context.appStage === 'CHANGE_EXAM_CITY' ?
                                        <div>
                                            {this.props.context.examCountry === 1 ? (<a class="btn btn-primary" href="changeExamCity.html">Change
                                            Personal Data</a>) : null}
                                        </div>
                                        :
                                        <a class="btn btn-primary" href="changeExamCity.html">Change
                                    Exam City</a>
